                        ...
                        <div class="form-validation">
                            ...
                            <form class="form-valide" action="{{ route('penghasilan.update') }}" method="POST">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6">
                                        <select class="form-control @error('valSatuan') is-invalid @enderror" id="valSatuan" name="valSatuan">
                                            <option value="Ton" {{ old('valSatuan') == 'Ton' || (isset($dataph) && $dataph->satuan == 'Ton') ? 'selected' : '' }}>Ton</option>
                                            <option value="KG" {{ old('valSatuan') == 'KG' || (isset($dataph) && $dataph->satuan == 'KG') ? 'selected' : '' }}>KG</option>
                                            <option value="Ekor" {{ old('valSatuan') == 'Ekor' || (isset($dataph) && $dataph->satuan == 'Ekor') ? 'selected' : '' }}>Ekor</option>
                                            <option value="Liter" {{ old('valSatuan') == 'Liter' || (isset($dataph) && $dataph->satuan == 'Liter') ? 'selected' : '' }}>Liter</option>
                                            <option value="Barang" {{ old('valSatuan') == 'Barang' || (isset($dataph) && $dataph->satuan == 'Barang') ? 'selected' : '' }}>Barang</option>
                                            <option value="Hari" {{ old('valSatuan') == 'Hari' || (isset($dataph) && $dataph->satuan == 'Hari') ? 'selected' : '' }}>Hari</option>
                                            <option value="Bulan" {{ old('valSatuan') == 'Bulan' || (isset($dataph) && $dataph->satuan == 'Bulan') ? 'selected' : '' }}>Bulan</option>
                                        </select>
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-4 col-form-label" for="valPenghasilanset">PENGHASILAN SETAHUN <span
                                            class="text-danger">*</span>
                                    </label>
                                    <div class="col-lg-6">
