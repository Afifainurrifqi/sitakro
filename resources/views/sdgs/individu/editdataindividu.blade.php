                    ...
                    <div class="form-validation">
                        ...
                        <form class="form-valide" action="{{ route('individu.update') }}" method="POST">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-6">
                                    <input type="date" vc class="form-control @error('valUsiapertamamenikah') is-invalid @enderror" id="valUsiapertamamenikah" name="valUsiapertamamenikah" value="{{ $datai->usia_saat_pertama_kali_menikah ?? ''}}" placeholder="Tanggal lahir...">
