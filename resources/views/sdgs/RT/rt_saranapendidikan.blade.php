            ...
            <div class="card">
                <div class="card-body">
                    ...
                    @endif
                        ...
                        <form action="{{ route('rt_saranapendidikan.index') }}" method="GET">
                        ...
                        <table class="table table-striped table-bordered zero-configuration" data-s-dom="lrtip">
                            ...
                            <tbody>
                                ...
                                @foreach ( $datapenduduk as $row )
                                    <tr> 
                                        <td><a href="{{ route('rt_saranapendidikan.show', ['show' => $row->nik]) }}" class="btn mb-1 btn-info btn-sm" title="Lihat Data">
