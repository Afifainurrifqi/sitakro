    ...
    <div class="container-fluid">
        <div class="row justify-content-center">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <h1 class="card-title">EDIT LOKASI RT
                            {{ $datap->nama }}</h1>
                        ...
                        <div class="form-validation">
                            <form class="form-valide" action="{{ route('rtlokasi.update') }}" method="POST">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6">
                                        <input type="text" value="{{ $rt_lokasi->nama_ketuart ?? '' }}"
                                            class="form-control @error('valnama_ketuart') is-invalid @enderror"
                                            id="valnama_ketuart" name="valnama_ketuart" placeholder="Nama ketua RT...">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6">
                                        <input type="text" value="{{ $rt_lokasi->alamat ?? '' }}"
                                            class="form-control @error('valalamat') is-invalid @enderror"
                                            id="valalamat" name="valalamat" placeholder="Alamat...">
                                        @error('valalamat')
                                            <div id="" class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6">
                                        <input type="number" value="{{ $rt_lokasi->rt ?? '' }}"
                                            class="form-control @error('valrt') is-invalid @enderror"
                                            id="valrt" name="valrt" placeholder="Rt...">
                                        @error('valrt')
                                            <div id="" class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6">
                                        <input type="number" value="{{ $rt_lokasi->rw ?? '' }}"
                                            class="form-control @error('valrw') is-invalid @enderror"
                                            id="valrw" name="valrw" placeholder="RW...">
                                        @error('valrw')
                                            <div id="" class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6">
                                        <input type="text" value="{{ $rt_lokasi->nohp ?? '' }}"
                                            class="form-control @error('valnohp') is-invalid @enderror"
                                            id="valnohp" name="valnohp" placeholder="NO Hp...">
                                        @error('valnohp')
                                            <div id="" class="invalid-feedback">
                                                {{ $message }}
                                            </div>
