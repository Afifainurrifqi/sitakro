                ...
                <div class="card">
                    <div class="card-body">
                        <div class="card-header">
                            ...
                            <form action="{{ route('rtlembaga_ekonomi.index') }}" method="GET">
                            ...
                            <table class="table table-striped table-bordered zero-configuration" data-s-dom="lrtip">
                                ...
                                <tbody>
                                    ...
                                    @foreach ($datapenduduk as $row)
                                        <tr>
                                            <td><a href="{{ route('rtlembaga_ekonomi.show', ['show' => $row->nik]) }}"
                                                    class="btn mb-1 btn-info btn-sm" title="Lihat Data">
                                                    <i class="fas fa-book"></i> </a>
                                                <a href="{{ route('rtlembaga_ekonomi.edit', ['nik' => $row->nik]) }}"
