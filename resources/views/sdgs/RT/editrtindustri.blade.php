                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{ $rt_industri->jumlahindustrik_kulit ?? '' }}"
                                                ...
                                                id="valjumlahindustrik_kulit" name="valjumlahindustrik_kulit" placeholder="Jumlah...">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                            value="{{ $rt_industri->jumlahindustris_kulit ?? '' }}"
                                            class="form-control @error('valjumlahindustris_kulit') is-invalid @enderror"
                                            id="valjumlahindustris_kulit"
                                            name="valjumlahindustris_kulit"
                                            placeholder="Jumlah...">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" value="{{ $rt_industri->jumlahmanajemen_kulit ?? '' }}"
                                                ...
                                                id="valjumlahmanajemen_kulit" name="valjumlahmanajemen_kulit" placeholder="Jumlah...">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" value="{{ $rt_industri->jumlahpekerja_kulit ?? '' }}"
                                                ...
                                                id="valjumlahpekerja_kulit" name="valjumlahpekerja_kulit" placeholder="jumlah...">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{ $rt_industri->jumlahindustrik_kayu ?? '' }}"
                                                ...
                                                id="valjumlahindustrik_kayu" name="valjumlahindustrik_kayu" placeholder="Jumlah...">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                            value="{{ $rt_industri->jumlahindustris_kayu ?? '' }}"
                                            class="form-control @error('valjumlahindustris_kayu') is-invalid @enderror"
                                            id="valjumlahindustris_kayu"
                                            name="valjumlahindustris_kayu"
                                            placeholder="Jumlah...">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" value="{{ $rt_industri->jumlahmanajemen_kayu ?? '' }}"
                                                ...
                                                id="valjumlahmanajemen_kayu" name="valjumlahmanajemen_kayu" placeholder="Jumlah...">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" value="{{ $rt_industri->jumlahpekerja_kayu ?? '' }}"
                                                ...
                                                id="valjumlahpekerja_kayu" name="valjumlahpekerja_kayu" placeholder="jumlah...">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{ $rt_industri->jumlahindustrik_logam ?? '' }}"
                                                ...
                                                id="valjumlahindustrik_logam" name="valjumlahindustrik_logam" placeholder="Jumlah...">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                            value="{{ $rt_industri->jumlahindustris_logam ?? '' }}"
                                            class="form-control @error('valjumlahindustris_logam') is-invalid @enderror"
                                            id="valjumlahindustris_logam"
                                            name="valjumlahindustris_logam"
                                            placeholder="Jumlah...">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" value="{{ $rt_industri->jumlahmanajemen_logam ?? '' }}"
                                                ...
                                                id="valjumlahmanajemen_logam" name="valjumlahmanajemen_logam" placeholder="Jumlah...">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" value="{{ $rt_industri->jumlahpekerja_logam ?? '' }}"
                                                ...
                                                id="valjumlahpekerja_logam" name="valjumlahpekerja_logam" placeholder="jumlah...">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{ $rt_industri->jumlahindustrik_logamb ?? '' }}"
                                                class="form-control @error('valjumlahindustrik_logamb') is-invalid @enderror"
                                                id="valjumlahindustrik_logamb" name="valjumlahindustrik_logamb" placeholder="Jumlah...">
                                        ...
                                        <div class="form-group">
                                            ...
                                            id="valjumlahindustris_logamb"
                                            name="valjumlahindustris_logamb"
                                            placeholder="Jumlah...">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" value="{{ $rt_industri->jumlahmanajemen_logamb ?? '' }}"
                                                class="form-control @error('valjumlahmanajemen_logamb') is-invalid @enderror"
                                                id="valjumlahmanajemen_logamb" name="valjumlahmanajemen_logamb" placeholder="Jumlah...">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" value="{{ $rt_industri->jumlahpekerja_logamb ?? '' }}"
                                                ...
                                                id="valjumlahpekerja_logamb" name="valjumlahpekerja_logamb" placeholder="jumlah...">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{ $rt_industri->jumlahindustrik_kain ?? '' }}"
                                                ...
                                                id="valjumlahindustrik_kain" name="valjumlahindustrik_kain" placeholder="Jumlah...">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                            value="{{ $rt_industri->jumlahindustris_kain ?? '' }}"
                                            class="form-control @error('valjumlahindustris_kain') is-invalid @enderror"
                                            id="valjumlahindustris_kain"
                                            name="valjumlahindustris_kain"
                                            placeholder="Jumlah...">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" value="{{ $rt_industri->jumlahmanajemen_kain ?? '' }}"
                                                ...
                                                id="valjumlahmanajemen_kain" name="valjumlahmanajemen_kain" placeholder="Jumlah...">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" value="{{ $rt_industri->jumlahpekerja_kain ?? '' }}"
                                                ...
                                                id="valjumlahpekerja_kain" name="valjumlahpekerja_kain" placeholder="jumlah...">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{ $rt_industri->jumlahindustrik_keramik ?? '' }}"
                                                class="form-control @error('valjumlahindustrik_keramik') is-invalid @enderror"
                                                id="valjumlahindustrik_keramik" name="valjumlahindustrik_keramik" placeholder="Jumlah...">
                                        ...
                                        <div class="form-group">
                                            ...
                                            id="valjumlahindustris_keramik"
                                            name="valjumlahindustris_keramik"
                                            placeholder="Jumlah...">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" value="{{ $rt_industri->jumlahmanajemen_keramik ?? '' }}"
                                                class="form-control @error('valjumlahmanajemen_keramik') is-invalid @enderror"
                                                id="valjumlahmanajemen_keramik" name="valjumlahmanajemen_keramik" placeholder="Jumlah...">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" value="{{ $rt_industri->jumlahpekerja_keramik ?? '' }}"
                                                ...
                                                id="valjumlahpekerja_keramik" name="valjumlahpekerja_keramik" placeholder="jumlah...">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{ $rt_industri->jumlahindustrik_genteng ?? '' }}"
                                                class="form-control @error('valjumlahindustrik_genteng') is-invalid @enderror"
                                                id="valjumlahindustrik_genteng" name="valjumlahindustrik_genteng" placeholder="Jumlah...">
                                        ...
                                        <div class="form-group">
                                            ...
                                            id="valjumlahindustris_genteng"
                                            name="valjumlahindustris_genteng"
                                            placeholder="Jumlah...">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" value="{{ $rt_industri->jumlahmanajemen_genteng ?? '' }}"
                                                class="form-control @error('valjumlahmanajemen_genteng') is-invalid @enderror"
                                                id="valjumlahmanajemen_genteng" name="valjumlahmanajemen_genteng" placeholder="Jumlah...">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" value="{{ $rt_industri->jumlahpekerja_genteng ?? '' }}"
                                                ...
                                                id="valjumlahpekerja_genteng" name="valjumlahpekerja_genteng" placeholder="jumlah...">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{ $rt_industri->jumlahindustrik_anyaman ?? '' }}"
                                                class="form-control @error('valjumlahindustrik_anyaman') is-invalid @enderror"
                                                id="valjumlahindustrik_anyaman" name="valjumlahindustrik_anyaman" placeholder="Jumlah...">
                                        ...
                                        <div class="form-group">
                                            ...
                                            id="valjumlahindustris_anyaman"
                                            name="valjumlahindustris_anyaman"
                                            placeholder="Jumlah...">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" value="{{ $rt_industri->jumlahmanajemen_anyaman ?? '' }}"
                                                class="form-control @error('valjumlahmanajemen_anyaman') is-invalid @enderror"
                                                id="valjumlahmanajemen_anyaman" name="valjumlahmanajemen_anyaman" placeholder="Jumlah...">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" value="{{ $rt_industri->jumlahpekerja_anyaman ?? '' }}"
                                                ...
                                                id="valjumlahpekerja_anyaman" name="valjumlahpekerja_anyaman" placeholder="jumlah...">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{ $rt_industri->jumlahindustrik_makanan ?? '' }}"
                                                class="form-control @error('valjumlahindustrik_makanan') is-invalid @enderror"
                                                id="valjumlahindustrik_makanan" name="valjumlahindustrik_makanan" placeholder="Jumlah...">
                                        ...
                                        <div class="form-group">
                                            ...
                                            id="valjumlahindustris_makanan"
                                            name="valjumlahindustris_makanan"
                                            placeholder="Jumlah...">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" value="{{ $rt_industri->jumlahmanajemen_makanan ?? '' }}"
                                                class="form-control @error('valjumlahmanajemen_makanan') is-invalid @enderror"
                                                id="valjumlahmanajemen_makanan" name="valjumlahmanajemen_makanan" placeholder="Jumlah...">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" value="{{ $rt_industri->jumlahpekerja_makanan ?? '' }}"
                                                ...
                                                id="valjumlahpekerja_makanan" name="valjumlahpekerja_makanan" placeholder="jumlah...">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{ $rt_industri->jumlahindustrik_lainnya ?? '' }}"
                                                class="form-control @error('valjumlahindustrik_lainnya') is-invalid @enderror"
                                                id="valjumlahindustrik_lainnya" name="valjumlahindustrik_lainnya" placeholder="Jumlah...">
                                        ...
                                        <div class="form-group">
                                            ...
                                            id="valjumlahindustris_lainnya"
                                            name="valjumlahindustris_lainnya"
                                            placeholder="Jumlah...">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" value="{{ $rt_industri->jumlahmanajemen_lainnya ?? '' }}"
                                                class="form-control @error('valjumlahmanajemen_lainnya') is-invalid @enderror"
                                                id="valjumlahmanajemen_lainnya" name="valjumlahmanajemen_lainnya" placeholder="Jumlah...">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" value="{{ $rt_industri->jumlahpekerja_lainnya ?? '' }}"
                                                class="form-control @error('valjumlahpekerja_lainnya') is-invalid @enderror"
                                                id="valjumlahpekerja_lainnya" name="valjumlahpekerja_lainnya" placeholder="jumlah...">
