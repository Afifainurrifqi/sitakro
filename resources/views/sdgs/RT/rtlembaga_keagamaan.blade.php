            ...
            <div class="card">
                <div class="card-body">
                    ...
                    @endif
                        ...
                        <form action="{{ route('rtlembaga_keagamaan.index') }}" method="GET">
                        ...
                        <table class="table table-striped table-bordered zero-configuration" data-s-dom="lrtip">
                            ...
                            <tbody>
                                ...
                                @foreach ( $datapenduduk as $row )
                                    <tr> 
                                        <td><a href="{{ route('rtlembaga_keagamaan.show', ['show' => $row->nik]) }}" class="btn mb-1 btn-info btn-sm" title="Lihat Data">
