                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" value="{{ $akses_pendidikan->jaraktempuh_rumahs ?? ''  }}"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" value="{{ $akses_pendidikan->waktutempuh_rumahs ?? ''  }}"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control @error('valkemudahan_rumahs') is-invalid @enderror"
                                                ...
                                                <option value="Mudah"
                                                    {{ old('valkemudahan_rumahs') == 'Mudah' || (isset($akses_pendidikan) && $akses_pendidikan->kemudahan_rumahs == 'Mudah') ? 'selected' : '' }}>
                                                    Mudah</option>
                                                <option value="Tidak Mudah"
                                                    {{ old('valkemudahan_rumahs') == 'Tidak Mudah' || (isset($akses_pendidikan) && $akses_pendidikan->kemudahan_rumahs == 'Tidak Mudah') ? 'selected' : '' }}>
                                                    Tidak Mudah</option>
                                            </select>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" value="{{ $akses_pendidikan->jaraktempuh_rumahb ?? '' }}"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" value="{{ $akses_pendidikan->waktutempuh_rumahb ?? ''  }}"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" value="{{ $akses_pendidikan->jaraktempuh_poliklinik ?? ''  }}"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" value="{{ $akses_pendidikan->waktutempuh_poliklinik ?? ''  }}"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control @error('valkemudahan_poliklinik') is-invalid @enderror"
                                                ...
                                                <option value="Mudah"
                                                    {{ old('valkemudahan_poliklinik') == 'Mudah' || (isset($akses_pendidikan) && $akses_pendidikan->kemudahan_poliklinik == 'Mudah') ? 'selected' : '' }}>
                                                    Mudah</option>
                                                <option value="Tidak Mudah"
                                                    {{ old('valkemudahan_poliklinik') == 'Tidak Mudah' || (isset($akses_pendidikan) && $akses_pendidikan->kemudahan_poliklinik == 'Tidak Mudah') ? 'selected' : '' }}>
                                                    Tidak Mudah</option>
                                            </select>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" value="{{ $akses_pendidikan->jaraktempuh_puskesmas ?? ''  }}"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" value="{{ $akses_pendidikan->waktutempuh_puskesmas ?? ''  }}"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control @error('valkemudahan_puskesmas') is-invalid @enderror"
                                                ...
                                                <option value="Mudah"
                                                    {{ old('valkemudahan_puskesmas') == 'Mudah' || (isset($akses_pendidikan) && $akses_pendidikan->kemudahan_puskesmas == 'Mudah') ? 'selected' : '' }}>
                                                    Mudah</option>
                                                <option value="Tidak Mudah"
                                                    {{ old('valkemudahan_puskesmas') == 'Tidak Mudah' || (isset($akses_pendidikan) && $akses_pendidikan->kemudahan_puskesmas == 'Tidak Mudah') ? 'selected' : '' }}>
                                                    Tidak Mudah</option>
                                            </select>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" value="{{ $akses_pendidikan->jaraktempuh_poskedes  ?? '' }}"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" value="{{ $akses_pendidikan->waktutempuh_poskedes ?? '' }}"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control @error('valkemudahan_poskedes') is-invalid @enderror"
                                                ...
                                                <option value="Mudah"
                                                    {{ old('valkemudahan_poskedes') == 'Mudah' || (isset($akses_pendidikan) && $akses_pendidikan->kemudahan_poskedes == 'Mudah') ? 'selected' : '' }}>
                                                    Mudah
                                                </option>
                                                <option value="Tidak Mudah"
                                                    {{ old('valkemudahan_poskedes') == 'Tidak Mudah' || (isset($akses_pendidikan) && $akses_pendidikan->kemudahan_poskedes == 'Tidak Mudah') ? 'selected' : '' }}>
                                                    Tidak Mudah
                                                </option>
                                            </select>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" value="{{ $akses_pendidikan->jaraktempuh_posyandu ?? ''  }}"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" value="{{ $akses_pendidikan->waktutempuh_posyandu ?? '' }}"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" value="{{ $akses_pendidikan->jaraktempuh_apotik ?? '' }}"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number"value="{{ $akses_pendidikan->waktutempuh_apotik ?? '' }}"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" value="{{ $akses_pendidikan->jaraktempuh_toko_obat ?? ''  }}"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" value="{{ $akses_pendidikan->waktutempuh_toko_obat ?? ''  }}"
                                        ...
                                        <option value="Mudah" {{ old('valkemudahan_toko_obat') == 'Mudah' || (isset($akses_pendidikan) && $akses_pendidikan->kemudahan_toko_obat == 'Mudah') ? 'selected' : '' }}>
                                            Mudah
                                        </option>
                                        <option value="Tidak Mudah" {{ old('valkemudahan_toko_obat') == 'Tidak Mudah' || (isset($akses_pendidikan) && $akses_pendidikan->kemudahan_toko_obat == 'Tidak Mudah') ? 'selected' : '' }}>
                                            Tidak Mudah
                                        </option>
                                    </select>
