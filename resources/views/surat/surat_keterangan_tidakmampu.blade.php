        ...
        <div class="card-body">
            ...
            <form action="{{ route('surat.tidakmampu.store') }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="kewarganegaraan" id="kewarganegaraan" class="form-control" required value="{{ old('kewarganegaraan') }}">
                </div>
                ...
                <div class="mb-3">
                    ...
                    <select name="status_surat" id="status_surat" class="form-control" required>
                        @foreach(['Pending', 'Di cek', 'Di terima', 'Ditolak'] as $statusSurat)
                            <option value="{{ $statusSurat }}" {{ old('status_surat') == $statusSurat ? 'selected' : '' }}>{{ $statusSurat }}</option>
                        @endforeach
                    </select>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <select name="status_verif" id="status_verif" class="form-control" required>
                        @foreach(['Belum Verifikasi', 'Terverifikasi'] as $statusVerif)
                            <option value="{{ $statusVerif }}" {{ old('status_verif') == $statusVerif ? 'selected' : '' }}>{{ $statusVerif }}</option>
                        @endforeach
                    </select>
                </div>
