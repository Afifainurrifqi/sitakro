        ...
        <div class="card-body">
            ...
            <form action="{{ route('surat.tidakmampu.update', $sktm->id) }}" method="POST" novalidate>
                ...
                @php
                    ...
                    $existingBantuan   = is_array($sktm->bantuan ?? null) ? $sktm->bantuan : (empty($sktm->bantuan) ? [] : (array) $sktm->bantuan);
                    $existingBantuanId = is_array($sktm->bantuan_id ?? null) ? $sktm->bantuan_id : (empty($sktm->bantuan_id) ? [] : (array) $sktm->bantuan_id);
                    ...
                    $tglLahir = old('tanggal_lahir',
                        !empty($sktm->tanggal_lahir)
                            ? (Carbon::parse($sktm->tanggal_lahir)->format('Y-m-d'))
                            : null
                    );
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="nama_lengkap" id="nama_lengkap"
                           ...
                           required value="{{ old('nama_lengkap', $sktm->nama_lengkap) }}">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="nik" id="nik"
                           ...
                           required value="{{ old('nik', $sktm->nik) }}">
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="tempat_lahir" id="tempat_lahir"
                               ...
                               required value="{{ old('tempat_lahir', $sktm->tempat_lahir) }}">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="kewarganegaraan" id="kewarganegaraan"
                           ...
                           required value="{{ old('kewarganegaraan', $sktm->kewarganegaraan) }}">
                ...
                <div class="mb-3">
                    ...
                    <select name="pekerjaan" id="pekerjaan"
                        ...
                        @foreach ($jobs as $job)
                            <option value="{{ $job }}"
                                {{ old('pekerjaan', $sktm->pekerjaan) == $job ? 'selected' : '' }}>
                                {{ $job }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div class="mb-3">
                    ...
                    @error('keterangan_fungsi_surat') <div class="invalid-feedback">{{ $message }}</div> @enderror
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="nowa" id="nowa"
                           ...
                           required value="{{ old('nowa', $sktm->nowa) }}">
