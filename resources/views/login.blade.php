...
<body>
	...
	<div class="container-fluid">
	    <div class="row row-height">
	        <div class="col-lg-6 background-image p-0" data-background="url(/assets2/img/bg.png)">
	            <div class="content-left-wrapper opacity-mask" data-opacity-mask="rgba(13, 110, 253, 0.8)">
	                <a href="#0" id="logo"><img src="/assets2/img/logodesa.png" alt="" width="46" height="55"></a>
	                <div id="social">
	                    <ul>
	                        <li><a href="#0" id="logo"><img src="/assets2/img/logodesa.png" alt="" width="46" height="55"></li>
	            ...
	            <div class="container my-auto py-5">
	                <div class="row">
	                    <div class="col-lg-9 col-xl-7 mx-auto position-relative">
							<h1 class="mb-3" style="text-align: center;"><img src="/assets2/img/logosi.png" alt="" width="" height="55"></h1>
	...
	<!-- COMMON SCRIPTS -->
    <script src="/assets2/js/common_scripts.js"></script>
	<script src="/assets2/js/common_func.js"></script>
