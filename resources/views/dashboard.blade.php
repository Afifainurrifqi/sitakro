                             ...
                             legend: {
                                 labels: {
                                     filter: function(item, data) {
                                         // Ambil semua data dan urutkan berdasarkan jumlah terbanyak
                                         let sortedIndices = pekerjaanCounts
                                             .map((count, index) => ({
                                                 index,
                                                 count
                                             }))
                                         ...
                                         // Tampilkan hanya jika index-nya ada di 5 besar
                                         return sortedIndices.includes(item.index);
                                     }
                                 }
                             },
                             tooltip: {
                                 callbacks: {
                                     label: function(tooltipItem) {
                                         var label = pekerjaanLabels[tooltipItem.dataIndex];
                                         var value = pekerjaanCounts[tooltipItem.dataIndex];
                                         return label + ': ' + value;
                                     }
                                 }
                             }
