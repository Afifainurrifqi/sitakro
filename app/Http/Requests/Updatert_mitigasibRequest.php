...
class Updatert_mitigasibRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        return [
            ...
            'valmitigasi_sp' => 'required',
            'valmitigasi_spd' => 'required',
            'valmitigasi_pk' => 'required',
            'valmitigasi_rrj' => 'required',
            'valmitigasi_ppn' => 'required',
